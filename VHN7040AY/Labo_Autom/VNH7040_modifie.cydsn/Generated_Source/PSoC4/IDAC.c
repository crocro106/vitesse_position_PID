...
void IDAC_Init(void)
{
    ...
    #if(IDAC_MODE_SOURCE == IDAC_IDAC_POLARITY)
        regVal  = IDAC_CSD_TRIM1_REG & ~(IDAC_CSD_IDAC_TRIM1_MASK);
        regVal |=  (IDAC_SFLASH_TRIM1_REG & IDAC_CSD_IDAC_TRIM1_MASK);
        IDAC_CSD_TRIM1_REG = regVal;
    #else
        regVal  = IDAC_CSD_TRIM2_REG & ~(IDAC_CSD_IDAC_TRIM2_MASK);
        regVal |=  (IDAC_SFLASH_TRIM2_REG & IDAC_CSD_IDAC_TRIM2_MASK);
        IDAC_CSD_TRIM2_REG = regVal;
    #endif /* (IDAC_MODE_SOURCE == IDAC_IDAC_POLARITY) */
