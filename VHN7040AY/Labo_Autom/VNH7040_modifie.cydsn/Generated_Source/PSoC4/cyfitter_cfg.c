...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A01), 0x80000003u);

	/* CYDEV_CLK_DIVIDER_B01 Starting address: CYDEV_CLK_DIVIDER_B01 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_B01), 0x80002039u);
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL1), 0x00333000u);
	...
	CY_SET_REG32((void *)(CYREG_PRT0_PC), 0x000920DAu);

	/* IOPINS0_1 Starting address: CYDEV_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT1_BASE), 0x00000038u);
	CY_SET_REG32((void *)(CYREG_PRT1_PC), 0x001B6C00u);
