...
uint32 IDAC7_initVar = 0u;


/*******************************************************************************
* Function Name: IDAC7_Init
****************************************************************************//**
*
...
void IDAC7_Init(void)
{
    ...
    IDAC7_IDAC_CONTROL_REG &= (~IDAC7_POLY_DYN  &
                                          ~IDAC7_LEG1_MODE_MASK &
                                          ~IDAC7_LEG2_MODE_MASK &
                                          ~IDAC7_DSI_CTRL_EN);

    CyExitCriticalSection(interruptState);

    /* Set initial configuration */
    IDAC7_SetValue(IDAC7_CURRENT_VALUE);
    IDAC7_SetPolarity(IDAC7_CURRENT_POLARITY);
    IDAC7_SetRange(IDAC7_CURRENT_RANGE);
}


/*******************************************************************************
* Function Name: IDAC7_Enable
****************************************************************************//**
*
...
void IDAC7_Enable(void)
{
    ...
    /* Enable CSD */
    IDAC7_CSD_CONTROL_REG |= IDAC7_IDAC_EN_CONFIG;
...
*  the entire CSD block is to use a specific define (IDAC7_CSD_CONFIG_ENABLE) 
*  for the m0s8csdv2 IP block control register (IDAC7_CSD_CONTROL_REG): 
*  IDAC7_CSD_CONTROL_REG &= ~IDAC7_CSD_CONFIG_ENABLE
*
* \globalvars
*  \ref IDAC7_initVar - this variable is used to indicate the initial
*  configuration of this component. The variable is initialized to zero and
*  set to 1 the first time IDAC7_Start() is called. This allows
...
void IDAC7_SetValue(uint32 current)
{
    ...
    newRegisterValue = IDAC7_IDAC_CONTROL_REG & ~IDAC7_CURRENT_VALUE_MASK;

    newRegisterValue |= ((current << IDAC7_CURRENT_VALUE_POS) & IDAC7_CURRENT_VALUE_MASK);

    IDAC7_IDAC_CONTROL_REG = newRegisterValue;
...
/*******************************************************************************
* Function Name: IDAC7_SetPolarity
****************************************************************************//**
*
...
void IDAC7_SetPolarity(uint32 polarity)
{
    ...
    newRegisterValue = IDAC7_IDAC_CONTROL_REG & ~IDAC7_POLARITY_MASK;

    newRegisterValue |= ((polarity << IDAC7_POLARITY_POS) & IDAC7_POLARITY_MASK);
...
*  * IDAC7_RNG_152_4UA  : 1.2 uA/bit current range
...
void IDAC7_SetRange(uint32 range)
{
    ...
    newRegisterValue = IDAC7_IDAC_CONTROL_REG & (~IDAC7_RANGE_MASK    &
                                                            ~IDAC7_LEG1_EN       &
                                                            ~IDAC7_LEG2_EN);

    newRegisterValue |= (range << IDAC7_RANGE_POS);
