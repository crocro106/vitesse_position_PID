// ======================================================================
// VNH7040-and.v generated from TopDesign.cysch
// 06/06/2021 at 21:00
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=1, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=65535, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=65534, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=65534, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=false, ReloadOnReset=false, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=QuadDec, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec, CY_INSTANCE_SHORT_NAME=QuadDec, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=QuadDec, )
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=1, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=3, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=3, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=FECH, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=FECH, CY_INSTANCE_SHORT_NAME=FECH, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=FECH, )
...
module top ;
	...
	wire [0:0] tmpOE__DI_Fdg_net;
	wire [0:0] tmpFB_0__DI_Fdg_net;
	wire [0:0] tmpIO_0__DI_Fdg_net;
	wire [0:0] tmpINTERRUPT_0__DI_Fdg_net;
	electrical [0:0] tmpSIOVREF__DI_Fdg_net;

	cy_psoc3_pins_v1_10
		#(.id("a2c1cd90-b2aa-4314-9d5f-45c621e5c1ce"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DI_Fdg
		 (.oe(tmpOE__DI_Fdg_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DI_Fdg_net[0:0]}),
		  .io({tmpIO_0__DI_Fdg_net[0:0]}),
		  .siovref(tmpSIOVREF__DI_Fdg_net),
		  .interrupt({tmpINTERRUPT_0__DI_Fdg_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DI_Fdg_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DI_Fdd_net;
	wire [0:0] tmpFB_0__DI_Fdd_net;
	wire [0:0] tmpIO_0__DI_Fdd_net;
	wire [0:0] tmpINTERRUPT_0__DI_Fdd_net;
	electrical [0:0] tmpSIOVREF__DI_Fdd_net;

	cy_psoc3_pins_v1_10
		#(.id("6ec7a058-ba52-45d2-9647-6f8c1f9ff825"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DI_Fdd
		 (.oe(tmpOE__DI_Fdd_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DI_Fdd_net[0:0]}),
		  .io({tmpIO_0__DI_Fdd_net[0:0]}),
		  .siovref(tmpSIOVREF__DI_Fdd_net),
		  .interrupt({tmpINTERRUPT_0__DI_Fdd_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DI_Fdd_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DI_ATU_net;
	wire [0:0] tmpFB_0__DI_ATU_net;
	wire [0:0] tmpIO_0__DI_ATU_net;
	wire [0:0] tmpINTERRUPT_0__DI_ATU_net;
	electrical [0:0] tmpSIOVREF__DI_ATU_net;

	cy_psoc3_pins_v1_10
		#(.id("9db661c0-017c-446e-93c1-e46c0797ee34"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DI_ATU
		 (.oe(tmpOE__DI_ATU_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DI_ATU_net[0:0]}),
		  .io({tmpIO_0__DI_ATU_net[0:0]}),
		  .siovref(tmpSIOVREF__DI_ATU_net),
		  .interrupt({tmpINTERRUPT_0__DI_ATU_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DI_ATU_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- DFF Start --
    reg  cydff_1;
    always @(posedge Net_4459)
    begin
        cydff_1 <= Net_1788;
    end
    assign Net_4505 = cydff_1;
    // -- DFF End --

	wire [0:0] tmpOE__DI_Index_net;
	wire [0:0] tmpIO_0__DI_Index_net;
	wire [0:0] tmpINTERRUPT_0__DI_Index_net;
	electrical [0:0] tmpSIOVREF__DI_Index_net;

	cy_psoc3_pins_v1_10
		#(.id("e75c78b4-9cb3-40df-9cd1-2a4238c8b647"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DI_Index
		 (.oe(tmpOE__DI_Index_net),
		  .y({1'b0}),
		  .fb({Net_828}),
		  .io({tmpIO_0__DI_Index_net[0:0]}),
		  .siovref(tmpSIOVREF__DI_Index_net),
		  .interrupt({tmpINTERRUPT_0__DI_Index_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DI_Index_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DI_PhiA_net;
	wire [0:0] tmpIO_0__DI_PhiA_net;
	wire [0:0] tmpINTERRUPT_0__DI_PhiA_net;
	electrical [0:0] tmpSIOVREF__DI_PhiA_net;

	cy_psoc3_pins_v1_10
		#(.id("9229aad5-9779-4c2c-94ac-fc1e526ec844"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DI_PhiA
		 (.oe(tmpOE__DI_PhiA_net),
		  .y({1'b0}),
		  .fb({Net_1788}),
		  .io({tmpIO_0__DI_PhiA_net[0:0]}),
		  .siovref(tmpSIOVREF__DI_PhiA_net),
		  .interrupt({tmpINTERRUPT_0__DI_PhiA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DI_PhiA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DI_PhiB_net;
	wire [0:0] tmpIO_0__DI_PhiB_net;
	wire [0:0] tmpINTERRUPT_0__DI_PhiB_net;
	electrical [0:0] tmpSIOVREF__DI_PhiB_net;

	cy_psoc3_pins_v1_10
		#(.id("93068c1d-8452-4009-8c06-462d77d1670e"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DI_PhiB
		 (.oe(tmpOE__DI_PhiB_net),
		  .y({1'b0}),
		  .fb({Net_4459}),
		  .io({tmpIO_0__DI_PhiB_net[0:0]}),
		  .siovref(tmpSIOVREF__DI_PhiB_net),
		  .interrupt({tmpINTERRUPT_0__DI_PhiB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DI_PhiB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Counter_v3_0_1 QuadDec (
        .capture(1'b0),
        .clock(Net_4491),
        .comp(Net_2233),
        .count(Net_4468),
        ...
        .up_ndown(Net_4502),
        .upCnt(1'b0));
    defparam QuadDec.CaptureMode = 0;
    defparam QuadDec.ClockMode = 1;
    defparam QuadDec.CompareMode = 1;
    defparam QuadDec.CompareStatusEdgeSense = 1;
    defparam QuadDec.EnableMode = 0;
    defparam QuadDec.ReloadOnCapture = 0;
    defparam QuadDec.ReloadOnCompare = 0;
    defparam QuadDec.ReloadOnOverUnder = 0;
    defparam QuadDec.ReloadOnReset = 0;
    defparam QuadDec.Resolution = 16;
    defparam QuadDec.RunMode = 0;
    defparam QuadDec.UseInterrupt = 1;

	wire [0:0] tmpOE__ENA_L298_net;
	wire [0:0] tmpFB_0__ENA_L298_net;
	wire [0:0] tmpIO_0__ENA_L298_net;
	wire [0:0] tmpINTERRUPT_0__ENA_L298_net;
	electrical [0:0] tmpSIOVREF__ENA_L298_net;

	cy_psoc3_pins_v1_10
		#(.id("24884ecb-a92b-42c9-bbf6-238c9aec4ac4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ENA_L298
		 (.oe(tmpOE__ENA_L298_net),
		  .y({Net_4498}),
		  .fb({tmpFB_0__ENA_L298_net[0:0]}),
		  .io({tmpIO_0__ENA_L298_net[0:0]}),
		  .siovref(tmpSIOVREF__ENA_L298_net),
		  .interrupt({tmpINTERRUPT_0__ENA_L298_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ENA_L298_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CyStatusReg_v1_90 Stat_dir (
        ...
        .status_7(1'b0),
        .status_bus(8'b0));
    defparam Stat_dir.Bit0Mode = 0;
    defparam Stat_dir.Bit1Mode = 0;
    defparam Stat_dir.Bit2Mode = 0;
    defparam Stat_dir.Bit3Mode = 0;
    defparam Stat_dir.Bit4Mode = 0;
    defparam Stat_dir.Bit5Mode = 0;
    defparam Stat_dir.Bit6Mode = 0;
    defparam Stat_dir.Bit7Mode = 0;
    defparam Stat_dir.BusDisplay = 0;
    defparam Stat_dir.Interrupt = 0;
    defparam Stat_dir.MaskValue = 0;
    defparam Stat_dir.NumInputs = 1;
    ...
    assign Net_2231 = 1'h0;

	wire [0:0] tmpOE__IN2_L298_net;
	wire [0:0] tmpFB_0__IN2_L298_net;
	wire [0:0] tmpIO_0__IN2_L298_net;
	wire [0:0] tmpINTERRUPT_0__IN2_L298_net;
	electrical [0:0] tmpSIOVREF__IN2_L298_net;

	cy_psoc3_pins_v1_10
		#(.id("3ca3cf72-8f1c-4ef6-bb77-46e3b552b317"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		IN2_L298
		 (.oe(tmpOE__IN2_L298_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__IN2_L298_net[0:0]}),
		  .io({tmpIO_0__IN2_L298_net[0:0]}),
		  .siovref(tmpSIOVREF__IN2_L298_net),
		  .interrupt({tmpINTERRUPT_0__IN2_L298_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IN2_L298_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__IN1_L298_net;
	wire [0:0] tmpFB_0__IN1_L298_net;
	wire [0:0] tmpIO_0__IN1_L298_net;
	wire [0:0] tmpINTERRUPT_0__IN1_L298_net;
	electrical [0:0] tmpSIOVREF__IN1_L298_net;

	cy_psoc3_pins_v1_10
		#(.id("57d632e9-0f4d-4f71-9912-bcf08085fd92"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		IN1_L298
		 (.oe(tmpOE__IN1_L298_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__IN1_L298_net[0:0]}),
		  .io({tmpIO_0__IN1_L298_net[0:0]}),
		  .siovref(tmpSIOVREF__IN1_L298_net),
		  .interrupt({tmpINTERRUPT_0__IN1_L298_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IN1_L298_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_4502 = ~Net_4505;


    assign Net_4468 = Net_1788 ^ Net_4459;
